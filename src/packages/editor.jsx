...
export default defineComponent({
    ...
    setup(props, ctx) {
        ...
        const buttons = [
            ...
            { label: '撤销', icon: 'fa fa-reply fa-lg', handler: () => commands.undo() },
            { label: '重做', icon: 'fa fa-share fa-lg', handler: () => commands.redo() },
            {
                label: '导出', icon: 'fa fa-sign-out fa-lg', handler: () => {
                    $dialog({
                        title: '导出json使用',
                        content: JSON.stringify(data.value),
                    })
            ...
            {
                label: '导入', icon: 'fa fa-sign-in fa-lg', handler: () => {
                    $dialog({
                        title: '导入json使用',
                        content: '',
                        footer: true,
            ...
            { label: '置顶', icon: 'fa fa-upload fa-lg', handler: () => commands.placeTop() },
            { label: '置底', icon: 'fa fa-download fa-lg', handler: () => commands.placeBottom() },
            { label: '删除', icon: 'fa fa-trash fa-lg', handler: () => commands.delete() },

            {
                label: () => previewRef.value ? '编辑' : '预览', icon: () => previewRef.value ? 'fa fa-edit fa-lg' : 'fa fa-eye fa-lg', handler: () => {
                    previewRef.value = !previewRef.value;
                    clearBlockFocus();
                }
            },
            {
                label: '关闭', icon: 'fa fa-close fa-lg', handler: () => {
